...
class BridgeRunLogTests(unittest.TestCase):
    ...
    def test_default_output_dir_can_use_private_model_workspace(self) -> None:
        with mock.patch.dict(os.environ, {"MBSE_MODEL_WORKSPACE": "/tmp/private-models"}):
            self.assertEqual(
                flexo_syson_bridge.default_output_dir(),
                Path("/tmp/private-models") / "exports",
            )
